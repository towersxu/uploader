...
(function (global, factory) {
  ...
  var Uploader = function (_Events) {
    ...
    function Uploader(file) {
      _classCallCheck$1(this, Uploader);

      var _this2 = _possibleConstructorReturn(this, _Events.call(this));
  ...
  var FileSdk = function (_Events) {
    _inherits$1(FileSdk, _Events);

    function FileSdk(file) {
      _classCallCheck$2(this, FileSdk);

      var _this = _possibleConstructorReturn$1(this, _Events.call(this));
    ...
    FileSdk.prototype.md5 = function md5() {
      var _this2 = this;

      this.trigger('md5');
      _md(this.file, function () {
        _this2.trigger('auth');
        setTimeout(function () {
          _this2.upload();
        }, 3000);
  ...
  var UiComponents = (_dec = mixin$1(Events.prototype), _dec(_class$1 = function (_Render) {
    _inherits$2(UiComponents, _Render);

    function UiComponents(theme) {
      _classCallCheck$3(this, UiComponents);

      var _this = _possibleConstructorReturn$2(this, _Render.call(this, theme));
  ...
  var Icon = function (_UiComponents) {
    _inherits$3(Icon, _UiComponents);
    ...
    function Icon(theme, suffix) {
      ...
      _classCallCheck$4(this, Icon);

      var _this = _possibleConstructorReturn$3(this, _UiComponents.call(this, theme));
  ...
  var Progress = function (_UiComponents) {
    _inherits$4(Progress, _UiComponents);

    function Progress(theme, name, suffix, size) {
      _classCallCheck$5(this, Progress);

      var _this = _possibleConstructorReturn$4(this, _UiComponents.call(this, theme));
  ...
  var ProgressBar = function (_UiComponents2) {
    _inherits$4(ProgressBar, _UiComponents2);

    function ProgressBar(theme, name, suffix, size) {
      _classCallCheck$5(this, ProgressBar);

      var _this2 = _possibleConstructorReturn$4(this, _UiComponents2.call(this, theme));
  ...
  var ProgressBg = function (_UiComponents3) {
    _inherits$4(ProgressBg, _UiComponents3);

    function ProgressBg(theme) {
      _classCallCheck$5(this, ProgressBg);

      var _this3 = _possibleConstructorReturn$4(this, _UiComponents3.call(this, theme));
  ...
  var FileSizeEl = function (_UiComponents4) {
    _inherits$4(FileSizeEl, _UiComponents4);

    function FileSizeEl(theme, size, status) {
      _classCallCheck$5(this, FileSizeEl);

      var _this4 = _possibleConstructorReturn$4(this, _UiComponents4.call(this, theme));
  ...
  var ProgressTools = function (_UiComponents5) {
    _inherits$4(ProgressTools, _UiComponents5);

    function ProgressTools(theme) {
      _classCallCheck$5(this, ProgressTools);

      var _this5 = _possibleConstructorReturn$4(this, _UiComponents5.call(this, theme));
  ...
  var Header = function (_UiComponents) {
    _inherits$5(Header, _UiComponents);

    function Header(theme) {
      var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

      _classCallCheck$6(this, Header);

      var _this = _possibleConstructorReturn$5(this, _UiComponents.call(this));
  ...
  var WebUi = function (_Render) {
    _inherits$6(WebUi, _Render);

    function WebUi(btnEl, fileListEl, theme) {
      _classCallCheck$7(this, WebUi);

      var _this = _possibleConstructorReturn$6(this, _Render.call(this, theme));
  ...
  var Uploader$1 = function () {
    ...
    function Uploader(_ref) {
      ...
      _classCallCheck$8(this, Uploader);
