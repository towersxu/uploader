...
(function (global, factory) {
  ...
  let _patch = init$1([classMod, stylMod, props$1, attributes$1, eventlisteners$1]); // NOTE: 先把所有的DOM操作放入这里处理，便于以后统一切换为其它处理。
  ...
  function () {
    ...
    _proto.appendElTo = function appendElTo() {};

    _proto.patch = function patch(oldVnode, newVnode) {
      _patch(oldVnode, newVnode);
    };

    _proto.h = function h$$1(...arg) {
      return h(...arg);
    };

    _proto.toVNode = function toVNode$$1(...arg) {
      return tovnode_1(...arg);
    };

    _proto.i18n = function i18n(key) {
      return I18n$1(key);
    };
  ...
  /*#__PURE__*/
  function (_Events) {
    _inheritsLoose(Uploader, _Events);
  ...
  /*#__PURE__*/
  function (_Events) {
    _inheritsLoose(FileSdk, _Events);
    ...
    var _proto = FileSdk.prototype;

    _proto.start = function start() {
      this.getFileMd5();
    };

    _proto.getFileMd5 = function getFileMd5$$1() {
      this.trigger('md5');
  ...
  let UiComponents = (_dec = mixin$1(Events.prototype), _dec(_class$1 =
  /*#__PURE__*/
  function (_Render) {
    _inheritsLoose(UiComponents, _Render);

    function UiComponents(theme) {
      var _this;

      _this = _Render.call(this, theme) || this;
      _this.listeners = {};
      return _this;
    }

    var _proto = UiComponents.prototype;
  ...
  function (_UiComponents) {
    _inheritsLoose(Icon, _UiComponents);

    function Icon(theme, suffix, width = 36, height = 36, cls, svgcls) {
      var _this;

      _this = _UiComponents.call(this, theme) || this;
      suffix = getIconSuffix(suffix);
      let str = `span.${_this.theme}-icon`;
  ...
  /*#__PURE__*/
  function (_UiComponents) {
    _inheritsLoose(Progress, _UiComponents);
    ...
    _proto.setProgress = function setProgress(p, loaded) {
      this.progressbg.setProgress(p);
      this.progressbar.setProgress(p, loaded);
    };

    _proto.setStatus = function setStatus(statu, data) {
  ...
  let ProgressBar =
  /*#__PURE__*/
  function (_UiComponents2) {
    _inheritsLoose(ProgressBar, _UiComponents2);

    function ProgressBar(theme, name, suffix, size) {
      var _this2;

      _this2 = _UiComponents2.call(this, theme) || this;
    ...
    _proto2.handlePTools = function handlePTools() {
    ...
    _proto2.setStatus = function setStatus(statu, data) {
      if (statu === 'auth') {
    ...
    _proto2.setProgress = function setProgress(p, loaded) {
  ...
  let ProgressBg =
  /*#__PURE__*/
  function (_UiComponents3) {
    _inheritsLoose(ProgressBg, _UiComponents3);

    function ProgressBg(theme) {
      var _this3;

      _this3 = _UiComponents3.call(this, theme) || this;
      _this3.el = _this3.h(`div.${_this3.theme}-progress-bg`);
      return _this3;
    }

    var _proto3 = ProgressBg.prototype;

    _proto3.setProgress = function setProgress(p) {
  ...
  let FileSizeEl =
  /*#__PURE__*/
  function (_UiComponents4) {
    _inheritsLoose(FileSizeEl, _UiComponents4);

    function FileSizeEl(theme, size, status) {
      var _this4;

      _this4 = _UiComponents4.call(this, theme) || this;
    ...
    var _proto4 = FileSizeEl.prototype;

    _proto4.setProgress = function setProgress(size) {
    ...
    _proto4.setStatus = function setStatus(type, text) {
      let el;
  ...
  let ProgressTools =
  /*#__PURE__*/
  function (_UiComponents5) {
    _inheritsLoose(ProgressTools, _UiComponents5);

    function ProgressTools(theme) {
      var _this5;

      _this5 = _UiComponents5.call(this, theme) || this;
      _this5.listeners = {};
    ...
    var _proto5 = ProgressTools.prototype;

    _proto5.createCloseIcon = function createCloseIcon() {
    ...
    _proto5.createPauseIcon = function createPauseIcon() {
    ...
    _proto5.createStartIcon = function createStartIcon() {
    ...
    _proto5.createMd5Icon = function createMd5Icon() {
    ...
    _proto5.pauseUpload = function pauseUpload() {
    ...
    _proto5.startUpload = function startUpload() {
    ...
    _proto5.deleteUpload = function deleteUpload() {
      this.trigger('delete');
    };
    /**
     * 上传成功,
    ...
    _proto5.uploadSuccess = function uploadSuccess() {
      if (!this.successEl) {
    ...
    _proto5.uploadFailed = function uploadFailed() {};
    /**
     * 根据不同的上传状态，显示不同的ICON
    ...
    _proto5.setStatus = function setStatus(statu) {
      // 上传成功
      if (statu === 'success') {
        this.uploadSuccess();
  ...
  /*#__PURE__*/
  function (_UiComponents) {
    _inheritsLoose(Header, _UiComponents);

    function Header(theme, status = 0) {
      var _this;

      _this = _UiComponents.call(this) || this;
      _this.theme = theme;
    ...
    _proto.getTextByStatus = function getTextByStatus(status) {
    ...
    _proto.changeStatus = function changeStatus(status) {
      ...
      if (this.el) {
        let newEl = this.h(`div.${this.theme}-fileset-header`, [this.h(`span.${this.theme}-header-text`, text)]);
        this.patch(this.el, newEl);
      }
    };
  ...
  function (_Render) {
    ...
    function WebUi(btnEl, fileListEl, theme) {
      ...
      _this = _Render.call(this, theme) || this;
      _this.btnEl = btnEl;
      _this.files = []; // this.fileListId = fileListEl.getAttribute('id')
    ...
    var _proto = WebUi.prototype;

    _proto.resetUploadBtn = function resetUploadBtn() {
    ...
    _proto.fileChange = function fileChange(e) {
      // todo: IE9 无法获取file
      let files = [];
      Array.prototype.map.call(e.target.files, f => {
        if (/\.([a-zA-Z]+?)$/.test(f.name)) {
          ...
          progress.on('pause', () => {// fs.pause()
          });
          progress.on('start', () => {// fs.start()
          });
          progress.on('delete', () => {// 1) 取消上传
            // 2) 上传上传进度条
            // 3) 同步修改上传文件对象列表
            // fs.cancel()
          });
    ...
    _proto.handleFiles = function handleFiles() {
      let allProgress = [];
      this.files.map(file => {
  ...
  const UI_TYPES = ['webui', // 带样式的web端文件上传
  ...
  function () {
    ...
    _proto.handleUploader = function handleUploader() {
      if (this.env === 'webui') {
    ...
    _proto.validate = function validate(env, ...arg) {
